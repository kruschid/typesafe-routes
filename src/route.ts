...
type ParamsRecord<Params extends Param[]> = {
...
export type ParamMap = Record<"params" | "query" | "state" | "hash", unknown>;
...
export type RouteContext<
  ...
  ChildRoutes extends RouteMap = {}
> = {
  params: Params;
  query: <Query extends Param<any, any, any>[]>(
    ...query: Query
  ) => RouteContext<Params & { query: ParamsRecord<Query> }>;
  hash: <Hash extends Param[]>(
    ...hash: Hash
  ) => RouteContext<Params & { hash: ParamsRecord<Hash> }>;
  state: <State extends Param[]>(
    ...state: State
  ) => RouteContext<Params & { state: ParamsRecord<State> }>;
  children: <Children extends Record<string, RouteContext<any, any>>>(
    children: Children
  ) => RouteContext<Params, Children>;
  child: ChildRoutes;
...
export const route: RouteTag = (strings, ...params) => {
  return null as any;
};
