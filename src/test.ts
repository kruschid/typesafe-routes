...
test("templates with default renderer", (t) => {
  ...
  console.log(
    routes.blog.category.date.$render({
      path: { cid: "", lang: "", date: new Date() },
    })
  );
  // routes.blog._.category.date.$render({
  //   path: { cid: "", date: new Date() },
  // });
  // routes.blog.category._.date.$render({
  //   path: { date: new Date() },
  // });
  // routes.blog._.category._.date.$render({
  //   path: { date: new Date() },
  // });
  // routes.blog.category.date._.$render({});
  t.end();
